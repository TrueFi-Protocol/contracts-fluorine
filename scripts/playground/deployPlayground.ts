import { FluorineDeployResult } from '../deployment/deployFluorine'
...
export function deployPlayground({ structuredPortfolioFactory, defaultDepositController, defaultWithdrawController, defaultTransferController, allowAllLenderVerifier }: FluorineDeployResult, deployer: string) {
  ...
  structuredPortfolioFactory.createAssetVault(usdc, portfolioParams, trancheData, { from: 200, to: 2000 }, false)
}
