...
struct DepositAllowed {
    /// @dev StructuredAssetVault status for which deposits should be enabled or disabled
    Status status;
...
interface IDepositController {
    ...
    /**
     * @notice Event emitted when deposits are disabled or enabled for a specific StructuredAssetVault status
     ...
     */
    event DepositAllowedChanged(bool newDepositAllowed, Status assetVaultStatus);
    ...
    /// @return Value indicating whether deposits are allowed when related StructuredAssetVault is in given status
     ...
     * @param newDepositAllowed Value indicating whether deposits should be allowed when related StructuredAssetVault is in given status
     * @param assetVaultStatus StructuredAssetVault status for which changes are applied
     */
    function setDepositAllowed(bool newDepositAllowed, Status assetVaultStatus) external;
